...
import requests
from ufma.constants import IGNORE_INDEX
from ufma.conversation import get_conv
...
def _read_video_decord(ele: dict, ) -> torch.Tensor:
    ...
    # Keep the frame count tied to the requested time span for now.
    # Using the clamped frame range directly changes checker behavior near boundaries,
    # so the safer long-term fix is to move this path to normalized timestamps end-to-end.
