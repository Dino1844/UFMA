...
@DATASETS.register(name='qvhighlights_checker_2b')
class QVHighlightsChecker2BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_qvhighlights_2b.json'

    SOURCE = 'qvhighlights_checker_2b'


@DATASETS.register(name='didemo_checker_2b')
class DiDeMoChecker2BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_didemo_2b.json'

    SOURCE = 'didemo_checker_2b'


@DATASETS.register(name='tacos_checker_2b')
class TACoSChecker2BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_tacos_2b.json'

    SOURCE = 'tacos_checker_2b'


@DATASETS.register(name='qvhighlights_checker_7b')
class QVHighlightsChecker7BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_qvhighlights_7b.json'

    SOURCE = 'qvhighlights_checker_7b'


@DATASETS.register(name='didemo_checker_7b')
class DiDeMoChecker7BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_didemo_7b.json'

    SOURCE = 'didemo_checker_7b'


@DATASETS.register(name='tacos_checker_7b')
class TACoSChecker7BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_tacos_7b.json'

    SOURCE = 'tacos_checker_7b'


@DATASETS.register(name='qvhighlights_checker_25_3b')
class QVHighlightsChecker25_3BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_qvhighlights_25_3b.json'

    SOURCE = 'qvhighlights_checker_25_3b'


@DATASETS.register(name='didemo_checker_25_3b')
class DiDeMoChecker25_3BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_didemo_25_3b.json'

    SOURCE = 'didemo_checker_25_3b'


@DATASETS.register(name='tacos_checker_25_3b')
class TACoSChecker25_3BDataset(CheckerDataset):

    ANNO_PATH = 'data/checker/checker_tacos_25_3b.json'

    SOURCE = 'tacos_checker_25_3b'
